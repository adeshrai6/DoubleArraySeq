...
public class DoubleArraySeq implements Cloneable{
    ...
    * @postcondition
    *   The new element has been added to the front of the sequence
   ...
   public double getElement(int n)
   {
      ...
      {
         throw new IllegalStateException("The element cannot be retrived because the sequence is empty or does not contain that many elements.");
      }
   }
    ...
    * @postcondition
    *   The current index is set to location.
    * @exception IllegalStateException
    *   Indicates the sequence is empty or location is larger than the sequence length
    **/
    ...
    * @poscondition
    *     If both object are equal it will return true
    */
    ...
    *  @param 
    *  @postcondition
    *       It returns message as String
    *  @exception IllegalStateException
    *       Indicates no current element 
    */
